...
:uri-plugin: https://github.com/danyill/oscd-replace-ieds
:uri-ci-bundle: https://danyill.github.io/oscd-replace-ieds/oscd-replace-ieds.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-replace-ieds/index.deploy.html
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-replace-ieds/dist/oscd-replace-ieds.js`. 
...
<.> Whether a document must be loaded for this plugin to be available
<.> URL which can be a local or remote resource. 
For a local resource, begins with a forward slash, e.g. `plugins/oscd-replace-ieds/dist/oscd-replace-ieds.js`. 
